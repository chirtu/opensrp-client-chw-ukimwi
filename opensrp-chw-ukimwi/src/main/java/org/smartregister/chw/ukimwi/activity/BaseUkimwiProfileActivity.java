package org.smartregister.chw.ukimwi.activity;
...
import org.smartregister.chw.ukimwi.custom_views.BaseUkimwiFloatingMenu;
import org.smartregister.chw.ukimwi.dao.UkimwiDao;
import org.smartregister.chw.ukimwi.domain.MemberObject;
import org.smartregister.chw.ukimwi.interactor.BaseUkimwiProfileInteractor;
...
public class BaseUkimwiProfileActivity extends BaseProfileActivity implements UkimwiProfileContract.View, UkimwiProfileContract.InteractorCallBack {
    protected MemberObject memberObject;
    protected UkimwiProfileContract.Presenter profilePresenter;
    protected CircleImageView imageView;
    protected TextView textViewName;
    protected TextView textViewGender;
    protected TextView textViewLocation;
    protected TextView textViewUniqueID;
    protected TextView textViewRecordUkimwi;
    ...
    protected RelativeLayout rlUkimwiPositiveDate;
    ...
    protected BaseUkimwiFloatingMenu baseUkimwiFloatingMenu;

    public static void startProfileActivity(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, BaseUkimwiProfileActivity.class);
    ...
    protected void onCreation() {
        setContentView(R.layout.activity_ukimwi_profile);
        ...
        toolbar.setNavigationOnClickListener(v -> BaseUkimwiProfileActivity.this.finish());
        ...
        rlUkimwiPositiveDate = findViewById(R.id.rlUkimwiPositiveDate);
        ...
        textViewRecordUkimwi = findViewById(R.id.textview_record_ukimwi);
        ...
        rlUkimwiPositiveDate.setOnClickListener(this);
        textViewRecordUkimwi.setOnClickListener(this);
        textViewRecordAnc.setOnClickListener(this);
        textViewUndo.setOnClickListener(this);

        imageRenderHelper = new ImageRenderHelper(this);
        memberObject = UkimwiDao.getMember(baseEntityId);
        initializePresenter();
    ...
    protected void initializePresenter() {
        ...
        profilePresenter = new BaseUkimwiProfilePresenter(this, new BaseUkimwiProfileInteractor(), memberObject);
        fetchProfileData();
    ...
    public void initializeFloatingMenu() {
        if (StringUtils.isNotBlank(memberObject.getPhoneNumber())) {
            baseUkimwiFloatingMenu = new BaseUkimwiFloatingMenu(this, memberObject);
            baseUkimwiFloatingMenu.setGravity(Gravity.BOTTOM | Gravity.RIGHT);
            LinearLayout.LayoutParams linearLayoutParams = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.MATCH_PARENT);
            addContentView(baseUkimwiFloatingMenu, linearLayoutParams);
        }
    }

    @Override
    public void hideView() {
        textViewRecordUkimwi.setVisibility(View.GONE);
    }
    ...
    public void setProfileViewWithData() {
        ...
        textViewGender.setText(UkimwiUtil.getGenderTranslated(this, memberObject.getGender()));
        ...
        if (StringUtils.isNotBlank(memberObject.getFamilyHead()) && memberObject.getFamilyHead().equals(memberObject.getBaseEntityId())) {
            findViewById(R.id.family_ukimwi_head).setVisibility(View.VISIBLE);
        }
        if (StringUtils.isNotBlank(memberObject.getPrimaryCareGiver()) && memberObject.getPrimaryCareGiver().equals(memberObject.getBaseEntityId())) {
            findViewById(R.id.primary_ukimwi_caregiver).setVisibility(View.VISIBLE);
        }
        if (memberObject.getUkimwiTestDate() != null) {
            textview_positive_date.setText(getString(R.string.ukimwi_positive) + " " + formatTime(memberObject.getUkimwiTestDate()));
        }
    }

    @Override
    public void setOverDueColor() {
        textViewRecordUkimwi.setBackground(getResources().getDrawable(R.drawable.record_btn_selector_overdue));
    }
    ...
    public void refreshUpComingServicesStatus(String service, AlertStatus status, Date date) {
        ...
        if (status == AlertStatus.upcoming) {
            tvUpComingServices.setText(UkimwiUtil.fromHtml(getString(R.string.vaccine_service_upcoming, service, dateFormat.format(date))));
        } else {
            tvUpComingServices.setText(UkimwiUtil.fromHtml(getString(R.string.vaccine_service_due, service, dateFormat.format(date))));
        }
    }
    ...
    public void refreshFamilyStatus(AlertStatus status) {
        ...
        if (status == AlertStatus.complete) {
            ...
            tvFamilyStatus.setText(UkimwiUtil.fromHtml(getString(R.string.family_has_service_overdue)));
        }
    }
