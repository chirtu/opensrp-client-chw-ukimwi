...
public class DBConstants {
    ...
    public final class KEY {
        ...
        public static final String DATE_CHW_UKIMWI_TEST = "date_chw_ukimwi_test";
        public static final String FEVER_UKIMWI_CHW = "fever_ukimwi_chw";
        public static final String FEVER_DURATION = "fever_duration";
        public static final String UKIMWI_RESULTS = "ukimwi_results";
        public static final String DATE_HF_UKIMWI_TEST = "date_hf_ukimwi_test";
        public static final String UKIMWI_TEST_DATE = "ukimwi_test_date";
        public static final String UKIMWI_TREAT = "ukimwi_treat";
        ...
        public static final String UKIMWI_EDU_CHW = "ukimwi_edu_chw";
        ...
        public static final String UKIMWI = "ukimwi";
        public static final String FAMILY_NAME = "family_name";
        public static final String PHONE_NUMBER = "phone_number";
        public static final String PHONE_NUMBER_UKIMWI = "phoneNumberUkimwi";
        public static final String GEST_AGE = "gest_age";
        public static final String DELIVERY_DATE = "delivery_date";
        public static final String UKIMWI_FOLLOW_UP_DATE = "date_chw_mfollowup";
