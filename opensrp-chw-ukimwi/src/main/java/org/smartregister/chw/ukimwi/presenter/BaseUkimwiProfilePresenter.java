...
public class BaseUkimwiProfilePresenter implements UkimwiProfileContract.Presenter {
    protected WeakReference<UkimwiProfileContract.View> view;
    protected MemberObject memberObject;
    protected UkimwiProfileContract.Interactor interactor;
    protected Context context;

    public BaseUkimwiProfilePresenter(UkimwiProfileContract.View view, UkimwiProfileContract.Interactor interactor, MemberObject memberObject) {
    ...
    @Override
    public void recordUkimwiButton(@Nullable String visitState) {
        if (getView() == null) {
            return;
        }
    ...
    @Override
    @Nullable
    public UkimwiProfileContract.View getView() {
