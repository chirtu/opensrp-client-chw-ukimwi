...
import org.smartregister.provider.UkimwiRegisterProvider;
...
public class BaseUkimwiRegisterFragment extends BaseRegisterFragment implements UkimwiRegisterFragmentContract.View {
    public static final String CLICK_VIEW_NORMAL = "click_view_normal";
    public static final String FOLLOW_UP_VISIT = "follow_up_visit";

    @Override
    public void initializeAdapter(Set<View> visibleColumns) {
        UkimwiRegisterProvider ukimwiRegisterProvider = new UkimwiRegisterProvider(getActivity(), paginationViewHandler, registerActionHandler, visibleColumns);
        clientAdapter = new RecyclerViewPaginatedAdapter(null, ukimwiRegisterProvider, context().commonrepository(this.tablename));
    ...
    public void setupViews(android.view.View view) {
        ...
        if (titleView != null) {
            ...
            titleView.setText(getString(R.string.ukimwi));
            titleView.setFontVariant(FontVariant.REGULAR);
        }
    }

    @Override
    public UkimwiRegisterFragmentContract.Presenter presenter() {
        return (UkimwiRegisterFragmentContract.Presenter) presenter;
    }
    ...
    protected void initializePresenter() {
        ...
        presenter = new BaseUkimwiRegisterFragmentPresenter(this, new BaseUkimwiRegisterFragmentModel(), null);
    }
...
//        start forms here if the module requires registration
    ...
    protected void openProfile(String baseEntityId) {
        BaseUkimwiProfileActivity.startProfileActivity(getActivity(), baseEntityId);
    }
