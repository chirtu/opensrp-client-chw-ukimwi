...
import org.smartregister.chw.ukimwi.interactor.BaseUkimwiRegisterInteractor;
import org.smartregister.chw.ukimwi.listener.UkimwiBottomNavigationListener;
import org.smartregister.chw.ukimwi.model.BaseUkimwiRegisterModel;
...
public class BaseUkimwiRegisterActivity extends BaseRegisterActivity implements UkimwiRegisterContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FORM_NAME = getIntent().getStringExtra(Constants.ACTIVITY_PAYLOAD.UKIMWI_FORM_NAME);
    ...
    public void startFormActivity(String formName, String entityId, String metaData) {
        try {
            if (mBaseFragment instanceof BaseUkimwiRegisterFragment) {
    ...
    public void startFormActivity(JSONObject jsonForm) {
        Intent intent = new Intent(this, BaseUkimwiRegisterActivity.class);
    ...
    public List<String> getViewIdentifiers() {
        return Arrays.asList(Constants.CONFIGURATION.UKIMWI_CONFIRMATION);
    }
    ...
    protected void registerBottomNavigation() {
        ...
        if (bottomNavigationView != null) {
            ...
            BottomNavigationListener familyBottomNavigationListener = new UkimwiBottomNavigationListener(this);
    ...
    protected void initializePresenter() {
        presenter = new BaseUkimwiRegisterPresenter(this, new BaseUkimwiRegisterModel(), new BaseUkimwiRegisterInteractor());
    }

    @Override
    protected BaseRegisterFragment getRegisterFragment() {
        return new BaseUkimwiRegisterFragment();
    }
    ...
    @Override
    public UkimwiRegisterContract.Presenter presenter() {
        return (UkimwiRegisterContract.Presenter) presenter;
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK && requestCode == Constants.REQUEST_CODE_GET_JSON) {
            ...
            try {
                ...
                JSONArray fieldsOne = UkimwiJsonFormUtils.fields(form, Constants.STEP_ONE);
...
//                process ukimwi form
    ...
    public void startClientProcessing() {
        try {
            ...
            UkimwiUtil.getClientProcessorForJava().processClient(UkimwiUtil.getSyncHelper().getEvents(lastSyncDate, BaseRepository.TYPE_Unprocessed));
