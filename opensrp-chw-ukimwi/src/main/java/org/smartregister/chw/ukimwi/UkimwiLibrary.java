package org.smartregister.chw.ukimwi;
...
public class UkimwiLibrary {
    private static UkimwiLibrary instance;
    ...
    public static void init(Context context, Repository repository, int applicationVersion, int databaseVersion) {
        if (instance == null) {
            instance = new UkimwiLibrary(context, repository, applicationVersion, databaseVersion);
        }
    }

    public static UkimwiLibrary getInstance() {
        if (instance == null) {
    ...
    private UkimwiLibrary(Context contextArg, Repository repositoryArg, int applicationVersion, int databaseVersion) {
